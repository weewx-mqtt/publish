...
2. Remove the [[plugins]] section and all of its subsections.
3. Install the desired version of MQTTPublish (greater than 1.2.0).
4. Add `MQTTConfigHA` to the [plugins option]({{ site.baseurl }}{% link common-options/index.md %}/#plugins).
5. Look for the [MQTTConfigHA] section and migrate the [[plugins]] [[[MQTTHomeAssistantConfig]]] section to it.
...
2. Remove the [[plugins]] section and all of its subsections.
3. Install the desired version of MQTTPublish (greater than 1.2.0).
4. Add `MQTTAggregateValues` to the [plugins option]({{ site.baseurl }}{% link common-options/index.md %}/#plugins).
5. Look for the [MQTTAggregateValues] section and migrate the [[plugins]] [[[MQTTAggregateValues]]] section to it.
    - This should only require removing two '[' from every section.
